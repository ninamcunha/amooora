...
dbscan_path = os.path.join(current_dir, "..", "pkl", "dbscan_model.pkl")
age_scaler_path = os.path.join(current_dir, "..", "pkl", "age_scaler.pkl")
height_scaler_path = os.path.join(current_dir, "..", "pkl", "height_scaler.pkl")
